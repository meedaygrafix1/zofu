        ...
        <main className="px-6 py-8 lg:px-8">
          {isChatActive ? (
            <motion.div
              ...
              className="max-w-3xl mx-auto h-[85vh] flex flex-col"
            >
          ...
          >
            <p className="text-xs text-muted-light">
              JobAmplify amplifies your existing experience — it never fabricates
            ...
            >
              <div className="p-6">
                ...
                <p className="text-sm text-muted">
                  Are you sure you want to sign out of JobAmplify? You will need to sign back in to access your workspace.
                </p>
              </div>
